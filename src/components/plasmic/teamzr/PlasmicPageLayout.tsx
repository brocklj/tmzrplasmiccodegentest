...
import * as sty from "./PlasmicPageLayout.module.css"; // plasmic-import: n_EE_khpzsQF/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Y9ugyYzyIcVR/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: ZdFkGSQK7mOb/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg___8YgFu)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__jOiPj)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__hg50P)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___8Xm9E)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__zaqZf)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
